...
#let gomaths(topic, body) = _e("aside", attrs: (class: "gobox gomaths"))[
  #_e("div", attrs: (class: "gf-head"))[∑ Go Further · The Maths#if topic != "" [: #_mk(topic)]#_e("span", attrs: (class: "gf-skip"))[skip if familiar]]
  #body
]
#let gopython(topic, body) = _e("aside", attrs: (class: "gobox gopython"))[
  #_e("div", attrs: (class: "gf-head"))[#_e("span", attrs: (class: "py-badge"))[PY] Go Further · Python#if topic != "" [: #_mk(topic)]#_e("span", attrs: (class: "gf-skip"))[skip if fluent]]
  #body
]
...
#let objectives(items) = _e("div", attrs: (class: "objectives"))[
  ...
  #_e("ul")[#for it in items { _e("li")[#_mk(it)] }]
]
...
#let scoreboard(caption: "", ..rows) = {
  ...
  _e("div", attrs: (class: "scoreboard"))[
    #_e("h4")[Scoreboard#if caption != "" [: #_mk(caption)]]
    #_e("table")[
