...
This is not a hypothetical. It happened, and it changed the internet. The story of compression is not just a story of clever algorithms. It is a story of lawyers, committees, lobbyists, corporate strategies, and the slow realization that a mathematical idea locked behind a patent can shape which technologies billions of people use. This chapter is that story.
...
#fig(
  ...
  cetz.canvas({
    ...
    for (x, label) in events {
      ...
      content((x, -0.6), text(size: 6.5pt)[#label])
    }
  })
)
...
#fig(
  ...
  cetz.canvas({
    ...
    for (x, y, label) in boxes {
      ...
      content((x + 1.9, y + 0.9), text(size: 7.5pt)[#label])
    }
